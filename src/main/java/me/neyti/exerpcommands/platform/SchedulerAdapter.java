package me.neyti.exerpcommands.platform;
...
public final class SchedulerAdapter {
    ...
    public SchedulerAdapter(Plugin plugin) {
        ...
        if (!foliaLike) {
            ...
            // Folia/ShreddedPaper с Folia API: используем Region/EntityScheduler
