package me.neyti.roleplaycommands;

import me.neyti.roleplaycommands.commands.*;
import me.neyti.roleplaycommands.model.Messages;
import me.neyti.roleplaycommands.listeners.CommandSendListener;
...
public class RoleplayCommands extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        RcCommand erpc = new RcCommand(this);
        register("rc", erpc, erpc);
